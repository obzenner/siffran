...
import { renderText, preserved, type ContractView } from "../src/obligations.ts";
...
for (const file of readdirSync(dir).filter(f => f.endsWith(".json"))) {
  ...
  if (fixture.before && fixture.after && fixture.expect?.ok !== undefined) test(`${file}: preserved`, () => assert.deepEqual(preserved(fixture.before, fixture.after), fixture.expect));
}
