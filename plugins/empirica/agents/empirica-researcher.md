...
`payload.source_ref`, and the exact quoted citation to `payload.citation`. Keep reasoning in the
handoff for the caller/auditor; do not substitute reasoning for a citation. The author never invokes
